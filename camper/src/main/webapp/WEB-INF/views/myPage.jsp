                  ...
                  <form method="post" action="/member/myPageModify">
                     <div class="row gtr-50 gtr-uniform">
                        ...
                        <div class="col-6 col-12-mobilep">
                           <input type="password" name="upw" id="password" value="${mypage.upw}" placeholder="패스워드" />
                        </div>
                        <div class="col-6 col-12-mobilep">
                        ...
                        <div class="col-12">
                           ...
                           <br>
                        <input type="text" name="uanswer" id="answer" value="${ mypage.uanswer }" placeholder="정답" />
                        </div>
                        
                        
                        <div class="col-6 col-12-mobilep">
                           <input type="text" name="uname" id="firstName" value="${ mypage.uname }" placeholder="이름" />
                        </div>
<!--                         <div class="col-6 col-12-mobilep">
                         ...
                         <br>
                        <div class="col-6">
                           <input type="text" name=upostcode id="myZipcode" value="${ mypage.upostcode }" placeholder="우편번호" />
                        </div>
                        <div class="col-3">
                           <input type="button" name="find_zipcode" id="find_zipcode" value="우편번호 찾기" />
                        </div>
                        <div class="col-12">
                           <input type="text" name="uaddr" id="address" value="${ mypage.uaddr }" placeholder="주소" />
                        </div>
                        <div class="col-12">
                           <input type="text" name="uaddrdetail" id="addressDetail" value="${ mypage.uaddrdetail }" placeholder="상세주소" />
                        </div>
